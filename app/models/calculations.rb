module Calculations
  ...
  def three_mo_cagr(date)
    ...
    three_mo_cagr = total_return ** ( 1 / years_held )
  end
  ...
  def six_mo_cagr(date)
    ...
    total_return = divs_received + end_price - start_price
    years_held = (end_date - start_date) / 60 / 60 / 24 / 365.25
    six_mo_cagr = total_return ** ( 1 / years_held )
  end
  ...
  def one_yr_cagr(date)
    ...
    total_return = divs_received + end_price - start_price
    years_held = (end_date - start_date) / 60 / 60 / 24 / 365.25
    one_yr_cagr = total_return ** ( 1 / years_held )
  end
  ...
  def three_yr_cagr(date)
    ...
    total_return = divs_received + end_price - start_price
    years_held = (end_date - start_date) / 60 / 60 / 24 / 365.25
    three_yr_cagr = total_return ** ( 1 / years_held )
  end
  ...
  def five_yr_cagr(date)
    ...
    total_return = divs_received + end_price - start_price
    years_held = (end_date - start_date) / 60 / 60 / 24 / 365.25
    five_yr_cagr = total_return ** ( 1 / years_held )
  end
  ...
  def ten_yr_cagr(date)
    ...
    total_return = divs_received + end_price - start_price
    years_held = (end_date - start_date) / 60 / 60 / 24 / 365.25
    ten_yr_cagr = total_return ** ( 1 / years_held )
  end
